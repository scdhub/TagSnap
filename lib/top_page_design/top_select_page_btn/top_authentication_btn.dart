...
class TopAuthenticationBtn extends StatefulWidget {
  const TopAuthenticationBtn({super.key});

  @override
  State<TopAuthenticationBtn> createState() => _TopJudgmentButton();
}

class _TopJudgmentButton extends State<TopAuthenticationBtn> {
