...
class InboundPage extends StatefulWidget {
  ...
  @override
  State<InboundPage> createState() => _InboundPage();
}

class _InboundPage extends State<InboundPage> {
                ...
                TextButton(
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('出庫登録が完了しました')),
                    );
                  },
                  child: Text('OK'),
                ),
