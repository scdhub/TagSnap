...
class LocInventoryPage extends StatefulWidget {
  const LocInventoryPage({super.key});

  @override
  State<StatefulWidget> createState() => _LocInventoryPage();
}

class _LocInventoryPage extends State<LocInventoryPage>
